/**
 * Tenant API E2E Tests
 *
 * Auto-generated test stubs for GET /api/tenant
...
describe('ListTenants', () => {
  ...
  describe('GET /api/tenant', () => {
    ...
    it('returns 200 for authenticated request', async () => {
      const response = await client.get('/api/tenant');
    ...
    it('returns 401 for unauthenticated request', async () => {
      ...
      const response = await unauthed.get('/api/tenant');
